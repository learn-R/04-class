...
# En este práctico utilizaremos la base de datos de la Encuesta de Caracterización 
# Socioeconómica (CASEN)
# (http://observatorio.ministeriodesarrollosocial.gob.cl/encuesta-casen-en-pandemia-2020)
# Para ello, deben dirigirse al siguiente enlace(https://drive.google.com/drive/folders/1Orgb3Qb9LcjTfjYMdIdy7SWd3xDMrTbG?usp=sharing), 
# descargar el archivo datoscasen.sav, y pegarlo en la carpeta input/data de su 
# repositorio.  
# 
# Recuerden siempre consultar el manual/libro de códigos
...
# antes de trabajar una base de datos.
